...
(function() {
  ...
  function hydrateCatalog() {
    ...
    var url = API_BASE + '/api/ecommerce/storefront/products?websiteId=' + encodeURIComponent(WEBSITE_ID);
  ...
  function showLessonGate(root, err) {
    ...
    if (err && err.productSlug) {
      ...
      cta = '<a class="course-detail-enroll lesson-gate-cta" href="' + escapeAttr(pageUrl('/checkout?product=' + encodeURIComponent(err.productId))) + '">'
        + tx('ecom_coursesEnrollCta', 'View course & enroll') + '</a>';
    }
