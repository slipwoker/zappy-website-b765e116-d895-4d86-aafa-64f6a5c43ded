...
function stripHtmlToText(html) {
  ...
  function initSearch() {
      ...
      btn.addEventListener('click', function() {
        ...
        if (query.length >= 2) {
          ...
          if (isPreview) {
            ...
            url.searchParams.set('page', '/courses');
    ...
    if ((window.location.pathname === '/courses' || (window.location.pathname === '/courses' || window.location.pathname === '/products'))) {
      const urlParams = new URLSearchParams(window.location.search);
    ...
    if (verifyOtpBtn && otpCodeInput) {
      verifyOtpBtn.addEventListener('click', async function(e) {
        ...
        try {
          ...
          let targetPath = (returnUrl && returnUrl !== '/login') ? returnUrl : '/courses';
...
function refreshDynamicProductGridsAfterDiscount() {
  var t = {"products":"קורסים","ourProducts":"הקורסים שלנו","featuredProducts":"קורסים מומלצים","noFeaturedProducts":"עוד לא נבחרו קורסים מומלצים. צפו בכל הקורסים שלנו!","featuredCategories":"קנו לפי קטגוריה","all":"הכל","featured":"מומלצים","new":"חדשים","sale":"מבצעים","loadingProducts":"טוען קורסים...","cart":"עגלת קניות","yourCart":"עגלת הקניות שלך","emptyCart":"העגלה ריקה","total":"סה\"כ","proceedToCheckout":"המשך לתשלום","checkout":"תשלום","customerInfo":"פרטי לקוח","fullName":"שם מלא","email":"אימייל","phone":"טלפון","shippingAddress":"כתובת למשלוח","street":"רחוב ומספר","streetAndNumber":"רחוב ומספר","apartment":"דירה, קומה, כניסה","apartmentExt":"דירה, קומה, קוד בניין, הערות וכו'","city":"עיר","zip":"מיקוד","zipPostal":"מיקוד","countryRegion":"מדינה / אזור","stateProvince":"מדינה / מחוז","stateRequired":"נא לבחור מדינה / מחוז","saveAddressForNextTime":"שמור את הכתובת לפעם הבאה","shippingMethod":"שיטת משלוח","loadingShipping":"טוען שיטות משלוח...","payment":"תשלום","loadingPayment":"טוען אפשרויות תשלום...","orderSummary":"סיכום הזמנה","subtotal":"סכום ביניים","vat":"מע\"מ","vatIncluded":"כולל מע\"מ","shipping":"משלוח","discount":"הנחה","totalToPay":"סה\"כ לתשלום","placeOrder":"בצע הזמנה","login":"התחברות","customerLogin":"התחברות לקוחות","enterEmail":"הזן את כתובת האימייל שלך ונשלח לך קוד התחברות","emailAddress":"כתובת אימייל","sendCode":"שלח קוד","enterCode":"הזן את הקוד שנשלח לאימייל שלך","verificationCode":"קוד אימות","verify":"אמת","returnPolicy":"מדיניות החזרות","addToCart":"הוסף לעגלה","startingAt":"החל מ","addedToCart":"המוצר נוסף לעגלה!","remove":"הסר","noProducts":"אין קורסים להצגה כרגע","errorLoading":"שגיאה בטעינה","days":"ימים","currency":"₪","free":"חינם","freeAbove":"משלוח חינם מעל","noShippingMethods":"אין אפשרויות משלוח זמינות","viewAllResults":"הצג את כל התוצאות","searchProducts":"חיפוש קורסים","productDetails":"פרטי המוצר","viewDetails":"לפרטים נוספים","inStock":"במלאי","outOfStock":"אזל מהמלאי","pleaseSelect":"נא לבחור","sku":"מק\"ט","category":"קטגוריה","relatedProducts":"מוצרים דומים","frequentlyBoughtTogether":"לרכוש יחד","frequentlyBoughtTogetherSubtitle":"הוספת מוצרים נלווים לעגלה","bundleTotal":"סה\"כ לעגלה","addBundleToCart":"הוספת {count} מוצרים לעגלה","upsellFree":"חינם","productNotFound":"המוצר לא נמצא","backToProducts":"חזרה לקורסים","home":"בית","quantity":"כמות","unitLabels":{"piece":"יח'","kg":"ק\"ג","gram":"גרם","liter":"ליטר","ml":"מ\"ל"},"perUnit":"/","couponCode":"קוד קופון","enterCouponCode":"הזן קוד קופון","applyCoupon":"החל","removeCoupon":"הסר","couponApplied":"הקופון הוחל בהצלחה!","invalidCoupon":"קוד קופון לא תקין","couponExpired":"הקופון פג תוקף","couponMinOrder":"סכום הזמנה מינימלי","alreadyHaveAccount":"כבר יש לך חשבון?","loginHere":"התחבר כאן","signInHere":"התחבר כאן","mobileNumber":"מספר טלפון","loggedInAs":"מחובר כ:","logout":"התנתק","haveCouponCode":"יש לי קוד קופון","agreeToTerms":"אני מסכים/ה ל","termsAndConditions":"תנאי השימוש","pleaseAcceptTerms":"נא לאשר את תנאי השימוש","nameRequired":"נא להזין שם מלא","emailRequired":"נא להזין כתובת אימייל","emailInvalid":"כתובת אימייל לא תקינה","phoneRequired":"נא להזין מספר טלפון","shippingRequired":"נא לבחור שיטת משלוח","streetRequired":"נא להזין רחוב ומספר","cityRequired":"נא להזין עיר","paymentNotConfigured":"תשלום מקוון לא מוגדר","orderSuccess":"ההזמנה התקבלה!","thankYouOrder":"תודה על ההזמנה","orderNumber":"מספר הזמנה","orderConfirmation":"אישור הזמנה נשלח לאימייל שלך","orderProcessing":"ההזמנה שלך בטיפול. נעדכן אותך כשהמשלוח יצא לדרך.","continueShopping":"להמשך קניות","next":"הבא","contactInformation":"פרטי התקשרות","items":"פריטים","continueToHomePage":"המשך לדף הבית","transactionDate":"תאריך עסקה","paymentMethod":"אמצעי תשלום","orderDetails":"פרטי ההזמנה","loadingOrder":"טוען פרטי הזמנה...","orderNotFound":"לא נמצאה הזמנה","orderItems":"פריטים בהזמנה","paidAmount":"סכום ששולם","myAccount":"החשבון שלי","accountWelcome":"ברוך הבא","yourOrders":"ההזמנות שלך","noOrders":"אין עדיין הזמנות","orderDate":"תאריך","orderStatus":"סטטוס","orderTotal":"סה\"כ","viewOrder":"צפה בהזמנה","statusPending":"ממתין לתשלום","statusPaid":"שולם","statusProcessing":"בטיפול","statusShipped":"נשלח","statusDelivered":"נמסר","statusCancelled":"בוטל","notLoggedIn":"לא מחובר","pleaseLogin":"יש להתחבר כדי לצפות בחשבון","personalDetails":"פרטים אישיים","editProfile":"עריכת פרופיל","name":"שם","saveChanges":"שמור שינויים","cancel":"ביטול","addresses":"כתובות","addAddress":"הוסף כתובת","editAddress":"ערוך כתובת","deleteAddress":"מחק כתובת","setAsDefault":"הגדר כברירת מחדל","defaultAddress":"כתובת ברירת מחדל","addressLabel":"שם הכתובת","work":"עבודה","other":"אחר","noAddresses":"אין כתובות שמורות","confirmDelete":"האם אתה בטוח שברצונך למחוק?","profileUpdated":"הפרופיל עודכן בהצלחה","addressSaved":"הכתובת נשמרה בהצלחה","addressDeleted":"הכתובת נמחקה","saving":"שומר...","saveToFavorites":"שמור למועדפים","removeFromFavorites":"הסר ממועדפים","shareProduct":"שתף מוצר","linkCopied":"הקישור הועתק!","myFavorites":"המועדפים שלי","noFavorites":"אין עדיין מוצרים מועדפים","addedToFavorites":"נוסף למועדפים","removedFromFavorites":"הוסר מהמועדפים","loginToFavorite":"יש להתחבר כדי לשמור מועדפים","browseFavorites":"גלו את כל הקורסים שלנו","selectVariant":"בחר אפשרות","variantUnavailable":"לא זמין","color":"צבע","size":"מידה","material":"חומר","style":"סגנון","weight":"משקל","capacity":"קיבולת","length":"אורך","inquiryAbout":"פנייה בנושא","sendInquiry":"שלח פנייה","callNow":"התקשר עכשיו","specifications":"מפרט טכני","storeNote":"מידע נוסף","businessPhone":"[business_phone]","businessEmail":"[business_email]","allCourses":"כל הקורסים","viewAllCourses":"צפה בכל הקורסים"};
...
(function() {
  ...
  var WEBSITE_ID = window.zappyWebsiteId || (function() {
    var meta = document.querySelector('meta[name="zappy-website-id"]');
    return meta ? meta.getAttribute('content') : null;
  })();

  var API_BASE = window.zappyApiBase || '';
  ...
  // (server/i18n/storefront/<lang>.json) and gets translated by the same
  // pipeline as 'Add to Cart' / 'SKU' / etc. — matches the canonical
  // pattern enforced by tests/ecommerceUiCallSiteCoverage.test.js.
  // Fallback chain: getEcomText -> document.documentElement.lang
  //   -> localStorage zappy_lang -> the hardcoded English fallback below.
  function tx(key, fallback) {
    if (typeof getEcomText === 'function') {
      try { return getEcomText(key, fallback); } catch (e) { /* swallow */ }
    }
    return fallback;
  }
  ...
  function hydrateCatalog() {
    ...
    if (!grid) return;
    fetch(API_BASE + '/api/ecommerce/' + WEBSITE_ID + '/products?isActive=true', { credentials: 'include' })
      ...
      .then(function(payload) {
        ...
        grid.innerHTML = products.map(function(p) {
          ...
          var price = (typeof p.price === 'number' && p.price > 0)
            ...
            : tx('ecom_coursesFree', 'Free');
          return '<a class="course-card" href="/courses/' + encodeURIComponent(p.slug || p.id) + '">'
            + (img ? '<img src="' + img + '" alt="" />' : '')
            + '<h3>' + escapeHtml(p.name || '') + '</h3>'
            + '<p>' + escapeHtml(p.short_description || p.description || '') + '</p>'
  ...
  function hydrateCourseDetail() {
    ...
    fetch(API_BASE + '/api/courses/student/courses/' + encodeURIComponent(slug), { credentials: 'include' })
      ...
      .then(function(payload) {
        ...
        setText(root, '[data-zappy-course-description]', stripTags(c.description || ''));
        var img = root.querySelector('[data-zappy-course-image]');
        if (img && c.images && c.images[0]) img.src = c.images[0];
        var price = (typeof c.price === 'number' && c.price > 0)
          ? (c.currency || 'USD') + ' ' + c.price.toFixed(2)
          : tx('ecom_coursesFree', 'Free');
        setText(root, '[data-zappy-course-price]', price);

        var instructor = payload.instructor;
        if (instructor) {
          var iEl = root.querySelector('[data-zappy-course-instructor]');
          if (iEl) {
            iEl.innerHTML = (instructor.avatar_url ? '<img src="' + instructor.avatar_url + '" alt="" />' : '')
        ...
        if (payload.enrollment && payload.enrollment.status === 'active') {
          ...
          if (resume && payload.resumeLessonId) {
            resume.hidden = false;
            resume.href = '/lesson/' + payload.resumeLessonId;
          }
        } else {
          ...
          if (enroll) {
            enroll.addEventListener('click', function() {
              if (window.zappyCart && typeof window.zappyCart.addProduct === 'function') {
                ...
                location.href = '/checkout?product=' + encodeURIComponent(c.id);
              }
            });
          }
        }
  ...
  function renderCurriculum(el, modules) {
    if (!el) return;
    if (!modules.length) {
      el.innerHTML = '<p>' + tx('ecom_coursesCurriculumEmpty', 'Curriculum coming soon.') + '</p>';
      return;
    }
    el.innerHTML = modules.map(function(m) {
      var lessons = (m.lessons || []).map(function(l) {
        ...
        return '<li><a href="/lesson/' + l.id + '">' + escapeHtml(l.title || '') + '</a> ' + free + '</li>';
      }).join('');
  ...
  function hydrateLessonPlayer() {
    ...
    if (!root) return;
    var lessonId = (location.pathname.match(/^\/lesson\/([^\/]+)$/) || [])[1];
    if (!lessonId) return;

    api('/api/courses/student/lessons/' + encodeURIComponent(lessonId) + '/playback')
      .then(function(r) {
        if (r.status === 401) { location.href = '/login?return=' + encodeURIComponent(location.pathname); throw 0; }
        if (r.status === 403) { showLessonGate(root); throw 0; }
  ...
  function showLessonGate(root) {
    var body = root.querySelector('[data-zappy-lesson-body]');
    if (body) {
      body.innerHTML = '<div class="lesson-gate">'
        + '<p>' + tx('ecom_coursesLessonGate', 'Enroll in this course to access this lesson.') + '</p>'
        + '</div>';
    }
  }
  ...
  function renderLessonBody(root, payload) {
    ...
    if (lesson.lesson_type === 'video' && payload.playbackUrl) {
      body.innerHTML = '<div class="lesson-video"><mux-player playback-id="' + escapeAttr(payload.muxPlaybackId)
        + '" stream-type="on-demand" tokens=\'{"playback":"' + escapeAttr(payload.playbackToken || '') + '"}\'></mux-player></div>';
    } else if (lesson.lesson_type === 'text') {
      body.innerHTML = '<article class="lesson-text">' + (lesson.content_html || '') + '</article>';
    } else if (lesson.lesson_type === 'pdf' && payload.pdfUrl) {
      body.innerHTML = '<iframe class="lesson-pdf" src="' + escapeAttr(payload.pdfUrl) + '"></iframe>';
    } else if (lesson.lesson_type === 'audio' && payload.audioUrl) {
      body.innerHTML = '<audio controls src="' + escapeAttr(payload.audioUrl) + '"></audio>';
    } else if (lesson.lesson_type === 'quiz' || lesson.contentType === 'quiz' || payload.quizPending) {
      renderQuizPlayer(body, lesson.id);
      return;
    } else if (lesson.lesson_type === 'live') {
      ...
      if (nav) {
        nav.innerHTML = payload.modules.map(function(m) {
          var lessons = (m.lessons || []).map(function(l) {
            ...
            return '<li' + active + '><a href="/lesson/' + l.id + '">' + escapeHtml(l.title || '') + done + '</a></li>';
          }).join('');
          ...
          api('/api/courses/student/lessons/' + encodeURIComponent(lessonId) + '/quiz/submit', {
            ...
            .then(function(p) {
              ...
              if (data.passed && data.courseJustCompleted) {
                setTimeout(function() { location.href = '/my-learning'; }, 2000);
              }
            });
        });
      })
  ...
  function hydrateMyLearning() {
    ...
    api('/api/courses/student/my-learning')
      .then(function(r) { if (r.status === 401) { location.href = '/login?return=/my-learning'; throw 0; } return r.json(); })
      .then(function(payload) {
        ...
        grid.innerHTML = enrollments.map(function(e) {
          ...
          return '<a class="my-learning-card" href="/courses/' + encodeURIComponent(e.course_slug || e.product_id) + '">'
  ...
  function hydrateCertificate() {
    ...
    if (!root) return;
    var code = (location.pathname.match(/^\/certificate\/([^\/]+)$/) || [])[1];
    if (!code) return;
  ...
  function init() {
    ...
    if (path === '/my-learning') return hydrateMyLearning();
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b765e116-d895-4d86-aafa-64f6a5c43ded';
